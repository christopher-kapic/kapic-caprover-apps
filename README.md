...
After creating your One-Click app YAML, like [this](https://github.com/caprover/one-click-apps/blob/master/public/v4/apps/adminer.yml), you need to test it before creating a Pull Request. Here is how you test it:
